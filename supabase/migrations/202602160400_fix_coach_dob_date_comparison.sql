-- ============================================================================
-- Fix: date_of_birth comparison in check_profile_completion_milestone()
-- ============================================================================
-- date_of_birth is a DATE column, so comparing with '' (empty string) causes:
--   "invalid input syntax for type date"
-- This broke ALL coach profile updates when date_of_birth is non-NULL.
-- Fix: remove the != '' check — DATE columns are either NULL or a valid date.
-- ============================================================================
