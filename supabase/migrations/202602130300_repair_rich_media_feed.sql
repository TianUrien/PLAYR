-- ============================================================================
-- REPAIR Migration: Re-apply Rich Media Feed (202602130100)
-- Date: 2026-02-13
-- Description: Migration 202602130100 was recorded as applied but its SQL
--   content was never executed on the remote database. This repair migration
--   re-applies all missing objects:
--   1. search_vector columns + triggers + indexes on user_posts and profiles
--   2. create_user_post, update_user_post, create_transfer_post RPCs (video-aware)
--   3. get_home_feed RPC (post_type + metadata regression fix)
--   4. search_content RPC (full-text search across posts, people, clubs)
--
...
-- ============================================================================
-- 3. create_user_post — max 5 media, video validation
-- ============================================================================
...
-- ============================================================================
-- 4. update_user_post — max 5 media, video validation
-- ============================================================================
...
-- ============================================================================
-- 5. create_transfer_post — max 5 media, video validation
-- ============================================================================
...
-- ============================================================================
-- 6. get_home_feed — restore post_type + metadata (regression fix)
-- ============================================================================
...
-- ============================================================================
-- 7. search_content — full-text search across posts, people, clubs
-- ============================================================================
