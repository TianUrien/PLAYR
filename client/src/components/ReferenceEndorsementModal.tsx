  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} className="max-w-lg">
      <div className="space-y-6 p-6">
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-playr-primary">Add Endorsement</p>
          <h2 className="text-2xl font-bold text-gray-900">Share a few words about {requesterName}</h2>
