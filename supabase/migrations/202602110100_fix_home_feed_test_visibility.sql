-- ============================================================================
-- Migration: Fix Home Feed Test Account Visibility
-- Date: 2026-02-11
-- Description: Test account users could not see their own posts in the feed.
--   The test isolation filter unconditionally excluded all test account posts,
--   regardless of who was viewing. Fix: if the viewer IS a test account,
--   include test account posts; otherwise exclude them.
-- ============================================================================
...
COMMENT ON FUNCTION public.get_home_feed IS 'Fetches paginated home feed with system posts + user posts unified. Test account posts visible only to test account viewers.';
