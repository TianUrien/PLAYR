-- Revert handle_friendship_state to original (without block check)
-- Block enforcement for friendships is handled by block_user RPC
-- which deletes existing friendships on block.
