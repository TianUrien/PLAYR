-- ============================================================================
-- Profile milestones: only show 100% completion in Home feed
-- ============================================================================
-- Remove 60% and 80% milestone triggers from check_profile_completion_milestone().
-- Only 100% profile completion should generate a Home feed post.
-- The milestone types remain valid in the constraint for backward compatibility,
-- but new 60%/80% milestones will no longer be created.
-- ============================================================================
...
BEGIN
  ...
  ELSIF NEW.role = 'coach' THEN
    ...
    -- NOTE: date_of_birth is a DATE column — only check IS NOT NULL (no '' comparison)
